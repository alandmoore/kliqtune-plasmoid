...
class Appearance_Config(QWidget, Ui_Form):
    def __init__(self, parent):
        ...
        if self.parent.show_volume:
            self.show_volume_checkbox.setCheckState(Qt.Checked)
        else:
            self.show_volume_checkbox.setCheckState(Qt.Unchecked)
        
        if self.parent.use_icons:
            self.use_icons_checkbox.setCheckState(Qt.Checked)
        else:
            self.use_icons_checkbox.setCheckState(Qt.Unchecked)
    ...
    def get_show_volume(self):
        return self.show_volume_checkbox.isChecked()

    def get_use_icons(self):
        return self.use_icons_checkbox.isChecked()
